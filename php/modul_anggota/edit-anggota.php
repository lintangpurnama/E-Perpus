...
<head>
  ...
  <title>E-Perpus-Edit-Buku</title>
</head>
<body>
<div class="wrapper">
    <!--start top header-->
    ...
    <main class="page-content">
      ...
      <!--end breadcrumb-->
        ...
        <div class="content form-control mt-2">
            
        <form method="post" action="proses-edit-anggota.php">
                <input type="hidden" class="form-control" name="id_anggota" value="<?php echo $data_anggota['anggota_id']; ?>">
                <p>Nama</p>
                <p><input type="text" class="form-control" name="nama" value="<?php echo $data_anggota['anggota_nama']; ?>"></p>
                <p>Alamat</p>
                <p><input type="text" class="form-control" name="alamat" value="<?php echo $data_anggota['anggota_alamat']; ?>"></p>
                <p>Jenis Kelamin</p>
                <p>
                    <select name="jk">
