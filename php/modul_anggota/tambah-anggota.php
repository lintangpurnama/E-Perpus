...
<head>
  ...
  <title>E-Perpus-Tambah-Data</title>
</head>
<body>
<div class="wrapper">
    <!--start top header-->
    ...
    <main class="page-content">
      ...
      <!--end breadcrumb-->
        ...
        <div class="card-body">
          <div class="d-flex align-items-center">
            <h5 class="mb-0 mt-2">Daftar anggota</h5>
          </div>
          <div class="content">
            
          <form class="form-control mt-2"method="post" action="proses-tambah-anggota.php" enctype="multipart/form-data">
          <p>Nama</p>
                <p><input class="form-control" type="text" name="nama"></p>
                <p>Alamat</p>
                <p><input type="text" class="form-control" name="alamat"></p>
                <p>Jenis Kelamin</p>
                <p>
                    <select name="jk">
                ...
                <p>Telepon</p>
                <p><input type="text"class="form-control" name="no_telepon"></p>
                <p>
