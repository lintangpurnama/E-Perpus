      ...
      <!--end breadcrumb-->
        ...
        <div class="card-body">
          <div class="d-flex align-items-center">
            ...
            <a href="tambah-buku.php"><button class="btn btn-secondary">Tambah Data</button></a>
            </div>
          </div>
            ...
            <?php else : ?>
                ...
                <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="edit-buku.php?id_buku=<?php echo $buku['buku_id']; ?>" class="btn btn-primary">Edit</a>
                                <a href="delete-buku.php?id_buku=<?php echo $buku['buku_id']; ?>" class="btn btn-light" onclick="return confirm('anda yakin akan menghapus data?');">Hapus</a>
                            </td>
                        </tr>
                </tbody>
                <?php endforeach ?>
