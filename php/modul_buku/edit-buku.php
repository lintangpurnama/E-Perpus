      ...
      <!--end breadcrumb-->
        ...
        <div class="content form-control mt-2">
          ...
          <form method="post" action="proses-edit-buku.php" enctype="multipart/form-data">
                ...
                <p>Judul</p>
                <p><input type="text" name="judul" class="form-control"value="<?php echo $data_buku['buku_judul'] ?>"></p>
                ...
                <p>Deskripsi</p>
                <p><textarea name="deskripsi" class="form-control"><?php echo $data_buku['buku_deskripsi'] ?></textarea></p>

                <p>Jumlah</p>
                <p><input type="number" name="jumlah" class="form-control"  value="<?php echo $data_buku['buku_jumlah'] ?>"></p>
