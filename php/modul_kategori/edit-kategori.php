...
<head>
    ...
    <title>E-Perpus-Edit-Kategori</title>
</head>
    ...
    <div class="wrapper">
        ...
        <main class="page-content">
           ...
           <form method="post" action="proses-edit-kategori.php">
                ...
                <p>Kategori</p>
                <p><input type="text" name="kategori" class="form-control" value="<?php echo $data_kategori['kategori_nama'] ?>"></p>

                <p>
                    <input type="submit" class="btn btn-primary" value="Simpan">
                    <input type="reset" class="btn btn-light" value="Batal" onclick="self.history.back();">
                </p>
            </form>
        </div>
