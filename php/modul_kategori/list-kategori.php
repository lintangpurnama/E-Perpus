                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-auto position-relative">
                            ...
                            <a href="tambah-kategori.php"><button class="btn btn-secondary">tambah</button></a>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row"><?php echo $kategori['kategori_nama'] ?></th>
                                <td><a href="edit-kategori.php?id_kategori=<?php echo $kategori['kategori_id']; ?>"
