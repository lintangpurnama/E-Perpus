...
include "../modul_pengembalian/proses-list-pengembalian.php";
    ...
    <div class="wrapper">
        ...
        <main class="page-content">
            ...
            <table class="table">
                ...
                <tr>
                    <td scope="row"><?php echo $kembali['buku_judul'] ?></td>
                    ...
                    <td>
                        <a href="delete-pengembalian.php?id_kembali=<?php echo $kembali['kembali_id'] ?>"
                            onclick="return confirm('anda yakin akan menghapus data?')" class="btn btn-danger">Hapus</a>
                    </td>
                </tr>
                <?php endforeach ?>
            </table>
