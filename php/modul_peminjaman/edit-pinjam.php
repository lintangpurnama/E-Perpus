      ...
      <!--end breadcrumb-->
        ...
        <h3>Edit Data Peminjaman</h3>
            ...
            <input type="hidden" name="pinjam_id" value="<?php echo $id_pinjam ?>">
                ...
                <p>Tanggal Pinjam</p>
                <p><input type="date" class="form-select" name="tgl_pinjam" value="<?php echo $data_pinjam['tgl_pinjam'] ?>"></p>

                <p>Tanggal Jatuh Tempo</p>
                <p><input type="date" class="form-select" name="tgl_jatuh_tempo" value="<?php echo $data_pinjam['tgl_jatuh_tempo'] ?>"></p>
