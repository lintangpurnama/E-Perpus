...
<head>
    ...
    <title>E-Perpus-Form-Pinjam</title>
</head>
...
<body>
    <div class="wrapper">
                    ...
                    <ul class="navbar-nav align-items-center">
                        <li class="nav-item dropdown dropdown-large">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center">
                                            <img src="assets/alfi.jpeg" alt="" class="rounded-circle" width="60"
                                                height="60">
                                            <div class="ms-3">
                                ...
                                <li>
                                    <a class="dropdown-item" href="https://www.instagram.com/alfianidamaiyanti/"
                                        target="_blank">
                                        <div class="d-flex align-items-center">
                ...
                <div class="tab-content active">
                    <div class="tab-pane fade active show" id="pills-dashboards">
                        <div class="list-group list-group-flush">
                            ...
                            <a href="../modul_kategori/list-kategori.php" class="list-group-item"><i
                                    class="bi bi-card-list"></i>Data Kategori</a>
                            <a href="../modul_buku/list-buku.php" class="list-group-item"><i class="bi bi-book"></i>Data
                                Buku</a>
                            <a href="../modul_anggota/list-anggota.php" class="list-group-item"><i
                                    class="bi bi-file-earmark-person"></i>Data Anggota</a>
                            <a href="../modul_peminjaman/pinjam-data.php" class="list-group-item"><i
                                    class="bi bi-file-earmark-person-fill"></i>Data Peminjam</a>
                            <a href="../modul_pengembalian/list-pengembalian.php" class="list-group-item"><i
                                    class="bi bi-arrow-repeat"></i>Data Pengembalian</a>
                            <a href="../logout.php" class="list-group-item"><i class="bi bi-arrow-bar-left"></i>Log
                                out</a>
        ...
        <main class="page-content">
            ...
            ?>
                        <form class="form-control" action="proses-tambah-pinjam.php" method="post">
                            <p>Buku</p>
                            <p>
                                <select class="form-select" name="buku">
                                    <?php foreach ($data_buku as $buku): ?>
                                    <option value="<?php echo $buku['buku_id'] ?>"><?php echo $buku['buku_judul'] ?>
                                    </option>
                                    <?php endforeach ?>
                                </select>
                            </p>
                            ...
                            <p>Tanggal Pinjam</p>
                            <p><input class="form-select" type="date" name="tgl_pinjam"></p>

                            <p>Tanggal Jatuh Tempo</p>
                            <p><input class="form-select" type="date" name="tgl_jatuh_tempo"></p>
    ...
    <div class="switcher-body">
        ...
        <div class="offcanvas offcanvas-end shadow border-start-0 p-2" data-bs-scroll="true" data-bs-backdrop="false"
            ...
            <div class="offcanvas-body">
                ...
                <hr>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="DefaultTheme"
