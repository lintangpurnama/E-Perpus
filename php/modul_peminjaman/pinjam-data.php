...
<head>
    ...
    <title>E-Perpus-Data-Peminjam</title>
</head>
        ...
        <main class="page-content">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-auto position-relative">
                            ...
                            <a href="pinjam-form.php"><button class="btn btn-secondary">tambah</button></a>
            ...
            ?>
                        ...
                        <?php else : ?>
                            ...
                            <tr>
                                <th scope="row"><?php echo $pinjam['buku_judul'] ?></th>
                    ...
                    ?>
                                ...
                                <td>
                                    ...
                                    <a href="proses-delete-pinjam.php?id_pinjam=<?php echo $pinjam['pinjam_id']; ?>&&status=<?php echo $status; ?>&&buku_id=<?php echo $pinjam['buku_id']; ?>"
                                        ...
                                        class="btn btn-danger gap-1">Hapus</a>
                                </td>
                            </tr>
                            <?php endforeach ?>
                        </table>
